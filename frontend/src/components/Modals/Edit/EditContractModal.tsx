...
export const EditContractModal: React.FC<EditContractModalProps> = ({ 
  ...
  const updateContractMutation = useMutation({
    mutationFn: (data: EditContractFormData) => contractService.update(contract.id, data),
    onSuccess: () => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h3 className="text-lg font-medium text-gray-900 flex items-center">
            ...
            Modifier le Contrat {contract.contractNumber}
          </h3>
            ...
            <div className="relative">
              ...
              >
                ...
                {employeesList.map((employee: any) => (
                  <option key={employee.id} value={employee.id} selected={employee.id === contract.employeeId}>
