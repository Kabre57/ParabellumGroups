  ...
  return (
    <>
      <LogipaieCrudPage
        ...
        description="Attestations de travail générées selon LOGIPAIE RH."
        queryKey={['logipaie-attestations-travail']}
        ...
        emptyLabel="Aucune attestation de travail disponible."
      />
