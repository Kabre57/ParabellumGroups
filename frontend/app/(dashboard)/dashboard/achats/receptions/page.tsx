            ...
            {isDetailLoading ? (
              ...
              <>
                <div className="grid gap-3 md:grid-cols-2 text-sm">
                  ...
                  <div>
                    <div className="text-muted-foreground">Facture fournisseur</div>
                    {current.factureFournisseurUrl ? (
                      <a
                        href={current.factureFournisseurUrl}
                        target="_blank"
                        rel="noreferrer"
                        className="font-semibold text-blue-600 hover:underline"
                      >
                        {current.factureFournisseurName || 'Voir la facture'}
                      </a>
                    ) : (
                      <div className="font-semibold">Non renseignée</div>
                    )}
                  </div>
                </div>
