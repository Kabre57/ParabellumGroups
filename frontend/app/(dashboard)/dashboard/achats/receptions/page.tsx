...
const mockReceptions: Reception[] = [
  { id: '1', number: 'REC-2026-001', supplier: 'Dell France', date: '2026-01-20', products: 12, quantity: 45, amount: 58495.55, status: 'pending' },
  ...
  { id: '7', number: 'REC-2026-007', supplier: 'HP France', date: '2026-01-21', products: 18, quantity: 67, amount: 32890.00, status: 'pending' },
  { id: '8', number: 'REC-2026-008', supplier: 'Dell France', date: '2026-01-14', products: 9, quantity: 23, amount: 8050.00, status: 'received' },
];
