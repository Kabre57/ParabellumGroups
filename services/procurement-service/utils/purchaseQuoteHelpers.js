...
const serializeProforma = (proforma = {}) => ({
  ...
  committeeEvaluation: proforma.committeeEvaluation || null,
  ...
  committeeEvaluatedByServiceId: proforma.committeeEvaluatedByServiceId ?? null,
  ...
  committeeSignedByServiceId: proforma.committeeSignedByServiceId ?? null,
...
const serializeQuote = (demande = {}) => {
  ...
  return {
    ...
    fournisseurNomLibre: demande.fournisseurNomLibre || null,
    fournisseurNom: demande.fournisseurNomLibre || demande.fournisseurNom || demande.fournisseur?.nom || null,
...
const serializeOrder = (bon = {}) => ({
  ...
  enterpriseId: bon.enterpriseId ?? null,
  enterpriseName: bon.enterpriseName || null,
