...
const completePermissions = {
  ...
  analytics: {
    ...
    permissions: [
      ...
      { name: 'reports.read_financial', description: 'Voir les analyses financières' },
  ...
  customers: {
    ...
    permissions: [
      ...
      { name: 'customers.read_financial', description: 'Voir les infos financières clients' },
  ...
  system_settings: {
    ...
    permissions: [
      { name: 'system_settings.read', description: 'Consulter les paramètres système' },
  ...
  logs: {
    ...
    permissions: [
      { name: 'logs.read', description: 'Consulter les logs système' },
