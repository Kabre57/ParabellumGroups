...
const completePermissions = {
  dashboard: {
    ...
    permissions: [
      { name: 'dashboard.read', description: 'Accéder au tableau de bord principal' },
      { name: 'dashboard.read_analytics', description: 'Voir les statistiques et KPIs' },
      { name: 'dashboard.read_widgets', description: 'Voir les widgets personnalisés' },
  ...
  analytics: {
    ...
    permissions: [
      ...
      { name: 'reports.read_operations', description: 'Voir les analyses opérationnelles' },
      { name: 'reports.read_technical', description: 'Voir les analyses techniques' },
      { name: 'reports.create_report', description: 'Créer des rapports personnalisés' },
  ...
  roles: {
    label: 'Rôles',
    permissions: [
      { name: 'roles.read', description: 'Consulter les rôles' },
  ...
  audit_logs: {
    ...
    permissions: [
      ...
      { name: 'audit_logs.read_security', description: 'Voir les logs de sécurité' },
  ...
  opportunities: {
    ...
    permissions: [
      { name: 'opportunities.read', description: 'Consulter les opportunités' },
      { name: 'opportunities.read_all', description: 'Voir toutes les opportunités' },
      { name: 'opportunities.read_own', description: 'Voir uniquement ses opportunités' },
  ...
  customers: {
    ...
    permissions: [
      ...
      { name: 'customers.read_assigned', description: 'Voir uniquement les clients assignés' },
  ...
  employees: {
    ...
    permissions: [
      ...
      { name: 'employees.read_all', description: 'Voir tous les employés' },
      { name: 'employees.read_team', description: 'Voir uniquement son équipe' },
      ...
      { name: 'employees.read_sensitive', description: 'Voir les données sensibles (salaire, etc.)' },
  ...
  leaves: {
    ...
    permissions: [
      ...
      { name: 'leaves.read_all', description: 'Voir tous les congés' },
      { name: 'leaves.read_team', description: 'Voir les congés de son équipe' },
      { name: 'leaves.read_own', description: 'Voir uniquement ses congés' },
  ...
  attendance: {
    label: 'Présences',
    permissions: [
      { name: 'attendance.read', description: 'Consulter les présences' },
      { name: 'attendance.read_all', description: 'Voir toutes les présences' },
      { name: 'attendance.read_team', description: 'Voir les présences de son équipe' },
      { name: 'attendance.read_own', description: 'Voir uniquement sa présence' },
  ...
  evaluations: {
    label: 'Ã‰valuations',
    permissions: [
      { name: 'evaluations.read', description: 'Consulter les évaluations' },
      { name: 'evaluations.read_all', description: 'Voir toutes les évaluations' },
      { name: 'evaluations.read_team', description: 'Voir les évaluations de son équipe' },
      { name: 'evaluations.read_own', description: 'Voir uniquement ses évaluations' },
  ...
  loans: {
    ...
    permissions: [
      ...
      { name: 'loans.create', description: 'Créer des demandes de prÃªt' },
  ...
  materiel: {
    ...
    permissions: [
      { name: 'materiel.read', description: 'Consulter le matériel' },
  ...
  inventory: {
    ...
    permissions: [
      ...
      { name: 'inventory.read_warehouse', description: 'Voir uniquement son entrepôt' },
  ...
  warehouses: {
    label: 'Entrepôts',
    permissions: [
      { name: 'warehouses.read', description: 'Consulter les entrepôts' },
  ...
  emails: {
    ...
    permissions: [
      ...
      { name: 'emails.manage_templates', description: 'Gérer les modÃ¨les d\'email' }
    ]
  },
  ...
  system_settings: {
    ...
    permissions: [
      ...
      { name: 'system_settings.update_general', description: 'Modifier paramÃ¨tres généraux' },
      { name: 'system_settings.update_security', description: 'Modifier paramÃ¨tres de sécurité' },
  ...
  logs: {
    ...
    permissions: [
      ...
      { name: 'logs.read_database', description: 'Voir les logs base de données' },
  ...
  integrations: {
    label: 'Intégrations',
    permissions: [
      { name: 'integrations.read', description: 'Consulter les intégrations' },
