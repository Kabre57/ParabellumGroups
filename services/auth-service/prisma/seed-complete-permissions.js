...
const completePermissions = {
  ...
  dashboard: {
    ...
    permissions: [
      { name: 'dashboard.read', description: 'AccÃ©der au tableau de bord principal' },
      { name: 'dashboard.read_analytics', description: 'Voir les statistiques et KPIs' },
      { name: 'dashboard.read_widgets', description: 'Voir les widgets personnalisÃ©s' },
  ...
  analytics: {
    ...
    permissions: [
      { name: 'reports.read', description: 'Consulter les analyses' },
      { name: 'reports.read_financial', description: 'Voir les analyses financiÃ¨res' },
      { name: 'reports.read_sales', description: 'Voir les analyses commerciales' },
      { name: 'reports.read_hr', description: 'Voir les analyses RH' },
      { name: 'reports.read_operations', description: 'Voir les analyses opÃ©rationnelles' },
      { name: 'reports.read_technical', description: 'Voir les analyses techniques' },
      { name: 'reports.create_report', description: 'CrÃ©er des rapports personnalisÃ©s' },
      { name: 'reports.export', description: 'Exporter les rapports' },
      { name: 'reports.schedule', description: 'Programmer des rapports automatiques' }
    ]
  },
  ...
  users: {
    ...
    permissions: [
      ...
      { name: 'users.read_all', description: 'Voir tous les utilisateurs' },
      { name: 'users.read_own', description: 'Voir son propre profil uniquement' },
  ...
  roles: {
    label: 'RÃ´les',
    permissions: [
      { name: 'roles.read', description: 'Consulter les rÃ´les' },
  ...
  permissions: {
    label: 'Permissions',
    permissions: [
      { name: 'permissions.read', description: 'Consulter les permissions' },
  ...
  services: {
    ...
    permissions: [
      { name: 'services.read', description: 'Consulter les services' },
      { name: 'services.read_all', description: 'Voir tous les services' },
      { name: 'services.read_own', description: 'Voir uniquement son service' },
  ...
  audit_logs: {
    ...
    permissions: [
      { name: 'audit_logs.read', description: 'Consulter les journaux d\'audit' },
      { name: 'audit_logs.read_info', description: 'Voir les logs niveau INFO' },
      { name: 'audit_logs.read_warning', description: 'Voir les logs niveau WARNING' },
      { name: 'audit_logs.read_error', description: 'Voir les logs niveau ERROR' },
      { name: 'audit_logs.read_critical', description: 'Voir les logs niveau CRITICAL' },
      { name: 'audit_logs.read_security', description: 'Voir les logs de sÃ©curitÃ©' },
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // ðŸ’¼ COMMERCIAL & PROSPECTION
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  prospects: {
    label: 'Prospects',
    permissions: [
      { name: 'prospects.read', description: 'Consulter les prospects' },
      { name: 'prospects.read_all', description: 'Voir tous les prospects' },
      { name: 'prospects.read_own', description: 'Voir uniquement ses prospects' },
  ...
  opportunities: {
    ...
    permissions: [
      { name: 'opportunities.read', description: 'Consulter les opportunitÃ©s' },
      { name: 'opportunities.read_all', description: 'Voir toutes les opportunitÃ©s' },
      { name: 'opportunities.read_own', description: 'Voir uniquement ses opportunitÃ©s' },
  ...
  customers: {
    ...
    permissions: [
      ...
      { name: 'customers.read_all', description: 'Voir tous les clients' },
      { name: 'customers.read_assigned', description: 'Voir uniquement les clients assignÃ©s' },
      ...
      { name: 'customers.read_financial', description: 'Voir les infos financiÃ¨res clients' },
  ...
  contacts: {
    label: 'Contacts',
    permissions: [
      { name: 'contacts.read', description: 'Consulter les contacts' },
  ...
  interactions: {
    ...
    permissions: [
      { name: 'interactions.read', description: 'Consulter les interactions' },
      { name: 'interactions.read_all', description: 'Voir toutes les interactions' },
      { name: 'interactions.read_own', description: 'Voir uniquement ses interactions' },
  ...
  contracts: {
    ...
    permissions: [
      ...
      { name: 'contracts.read_all', description: 'Voir tous les contrats' },
  ...
  quotes: {
    ...
    permissions: [
      ...
      { name: 'quotes.read_all', description: 'Voir tous les devis' },
      { name: 'quotes.read_own', description: 'Voir uniquement ses devis' },
  ...
  payments: {
    ...
    permissions: [
      ...
      { name: 'payments.read_all', description: 'Voir tous les paiements' },
  ...
  products: {
    ...
    permissions: [
      { name: 'products.read', description: 'Consulter le catalogue produits' },
  ...
  employees: {
    label: 'EmployÃ©s',
    permissions: [
      { name: 'employees.read', description: 'Consulter les employÃ©s' },
      { name: 'employees.read_all', description: 'Voir tous les employÃ©s' },
      { name: 'employees.read_team', description: 'Voir uniquement son Ã©quipe' },
      { name: 'employees.read_own', description: 'Voir uniquement son dossier' },
      ...
      { name: 'employees.read_sensitive', description: 'Voir les donnÃ©es sensibles (salaire, etc.)' },
  ...
  employee_contracts: {
    ...
    permissions: [
      { name: 'employee_contracts.read', description: 'Consulter les contrats' },
      { name: 'employee_contracts.read_all', description: 'Voir tous les contrats' },
      { name: 'employee_contracts.read_own', description: 'Voir uniquement son contrat' },
  ...
  payroll: {
    label: 'Paie',
    permissions: [
      { name: 'payroll.read', description: 'Consulter les fiches de paie' },
      { name: 'payroll.read_all', description: 'Voir toutes les paies' },
      { name: 'payroll.read_own', description: 'Voir uniquement sa paie' },
  ...
  leaves: {
    label: 'CongÃ©s',
    permissions: [
      { name: 'leaves.read', description: 'Consulter les congÃ©s' },
      { name: 'leaves.read_all', description: 'Voir tous les congÃ©s' },
      { name: 'leaves.read_team', description: 'Voir les congÃ©s de son Ã©quipe' },
      { name: 'leaves.read_own', description: 'Voir uniquement ses congÃ©s' },
  ...
  attendance: {
    label: 'PrÃ©sences',
    permissions: [
      { name: 'attendance.read', description: 'Consulter les prÃ©sences' },
      { name: 'attendance.read_all', description: 'Voir toutes les prÃ©sences' },
      { name: 'attendance.read_team', description: 'Voir les prÃ©sences de son Ã©quipe' },
      { name: 'attendance.read_own', description: 'Voir uniquement sa prÃ©sence' },
  ...
  evaluations: {
    label: 'Ã‰valuations',
    permissions: [
      { name: 'evaluations.read', description: 'Consulter les Ã©valuations' },
      { name: 'evaluations.read_all', description: 'Voir toutes les Ã©valuations' },
      { name: 'evaluations.read_team', description: 'Voir les Ã©valuations de son Ã©quipe' },
      { name: 'evaluations.read_own', description: 'Voir uniquement ses Ã©valuations' },
  ...
  loans: {
    ...
    permissions: [
      { name: 'loans.read', description: 'Consulter les prÃªts' },
      { name: 'loans.read_all', description: 'Voir tous les prÃªts' },
      { name: 'loans.read_own', description: 'Voir uniquement ses prÃªts' },
  ...
  techniciens: {
    ...
    permissions: [
      ...
      { name: 'techniciens.read_performance', description: 'Voir les performances' }
    ]
  },
  ...
  specialites: {
    ...
    permissions: [
      { name: 'specialites.read', description: 'Consulter les spÃ©cialitÃ©s' },
  ...
  missions: {
    ...
    permissions: [
      ...
      { name: 'missions.read_all', description: 'Voir toutes les missions' },
      { name: 'missions.read_assigned', description: 'Voir uniquement ses missions' },
  ...
  interventions: {
    ...
    permissions: [
      ...
      { name: 'interventions.read_all', description: 'Voir toutes les interventions' },
      { name: 'interventions.read_assigned', description: 'Voir uniquement ses interventions' },
  ...
  rapports_techniques: {
    ...
    permissions: [
      { name: 'rapports_techniques.read', description: 'Consulter les rapports techniques' },
      { name: 'rapports_techniques.read_all', description: 'Voir tous les rapports' },
      { name: 'rapports_techniques.read_own', description: 'Voir uniquement ses rapports' },
  ...
  materiel: {
    ...
    permissions: [
      { name: 'materiel.read', description: 'Consulter le matÃ©riel' },
  ...
  projects: {
    ...
    permissions: [
      ...
      { name: 'projects.read_all', description: 'Voir tous les projets' },
      { name: 'projects.read_assigned', description: 'Voir uniquement ses projets' },
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // ðŸ›’ APPROVISIONNEMENT & ACHATS
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  suppliers: {
    label: 'Fournisseurs',
    permissions: [
      { name: 'suppliers.read', description: 'Consulter les fournisseurs' },
  ...
  purchase_orders: {
    ...
    permissions: [
      { name: 'purchase_orders.read', description: 'Consulter les bons de commande' },
  ...
  expenses: {
    label: 'DÃ©penses',
    permissions: [
      { name: 'expenses.read', description: 'Consulter les dÃ©penses' },
      { name: 'expenses.read_all', description: 'Voir toutes les dÃ©penses' },
      { name: 'expenses.read_own', description: 'Voir uniquement ses dÃ©penses' },
  ...
  inventory: {
    label: 'Inventaire',
    permissions: [
      { name: 'inventory.read', description: 'Consulter l\'inventaire' },
      { name: 'inventory.read_all', description: 'Voir tous les stocks' },
      { name: 'inventory.read_warehouse', description: 'Voir uniquement son entrepÃ´t' },
  ...
  warehouses: {
    label: 'EntrepÃ´ts',
    permissions: [
      { name: 'warehouses.read', description: 'Consulter les entrepÃ´ts' },
  ...
  stock_movements: {
    ...
    permissions: [
      { name: 'stock_movements.read', description: 'Consulter les mouvements' },
  ...
  notifications: {
    label: 'Notifications',
    permissions: [
      { name: 'notifications.read', description: 'Consulter les notifications' },
      { name: 'notifications.read_own', description: 'Voir uniquement ses notifications' },
  ...
  messages: {
    ...
    permissions: [
      { name: 'messages.read', description: 'Consulter les messages' },
  ...
  emails: {
    label: 'Emails',
    permissions: [
      { name: 'emails.read', description: 'Consulter l\'historique d\'emails' },
  ...
  system_settings: {
    ...
    permissions: [
      { name: 'system_settings.read', description: 'Consulter les paramÃ¨tres systÃ¨me' },
  ...
  backups: {
    label: 'Sauvegardes',
    permissions: [
      { name: 'backups.read', description: 'Consulter les sauvegardes' },
  ...
  logs: {
    ...
    permissions: [
      { name: 'logs.read', description: 'Consulter les logs systÃ¨me' },
      { name: 'logs.read_application', description: 'Voir les logs applicatifs' },
      { name: 'logs.read_database', description: 'Voir les logs base de donnÃ©es' },
      { name: 'logs.read_error', description: 'Voir les logs d\'erreur' },
  ...
  integrations: {
    label: 'IntÃ©grations',
    permissions: [
      { name: 'integrations.read', description: 'Consulter les intÃ©grations' },
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // ðŸ“„ DOCUMENTS & FICHIERS
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  documents: {
    label: 'Documents',
    permissions: [
      { name: 'documents.read', description: 'Consulter les documents' },
      { name: 'documents.read_all', description: 'Voir tous les documents' },
      { name: 'documents.read_own', description: 'Voir uniquement ses documents' },
...
async function seedCompletePermissions() {
  ...
  console.log(`   âŒ Erreurs rencontrÃ©es:           ${totalErrors.toString().padStart(4)}`);
  console.log(`   â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”`);
  console.log(`   ðŸ“ Total traitÃ©:                  ${(totalCreated + totalSkipped + totalErrors).toString().padStart(4)}`);

  // Compter le total en base
  const totalInDb = await prisma.permission.count();
  console.log(`\nðŸ’¾ Total de permissions en base de donnÃ©es: ${totalInDb}`);
