...
module.exports = {
  ...
  routes: [
    ...
    },
    {
      ...
      auth: true,
      permission: {
        GET: ['opportunities.read', 'opportunities.read_all', 'opportunities.read_own', 'customers.read', 'prospects.read'],
        POST: ['opportunities.create', 'prospects.create', 'customers.create'],
        PUT: ['opportunities.update', 'customers.update', 'prospects.update'],
        PATCH: ['opportunities.change_stage', 'opportunities.update', 'customers.update', 'prospects.update'],
